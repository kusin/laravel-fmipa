    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <span class="text-dark">Data Pengujian Material | Form Tambah Data</span>
            </div>
        </div>
        {{-- /.col --}}
    </div>
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select wire:model="id_mitra" class="form-control form-control-border border-success border-width-2" id="id_mitra" disabled>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-4 mb-4">
                                ...
                                <input wire:model="qty_sampel" type="number" class="form-control form-control-border border-success border-width-2" id="qty_sampel" placeholder="QTY sampel tidak boleh kosong">
