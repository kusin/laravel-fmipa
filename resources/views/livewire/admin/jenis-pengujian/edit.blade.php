    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="callout callout-warning">
                <span class="text-dark">Jenis Pengujian | Form Ubah Data</span>
            </div>
        </div> {{-- /.col --}}
    </div> {{-- /.row --}}
                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="nama_pengujian" type="text" class="form-control form-control-border border-warning border-width-2" id="nama_pengujian" placeholder="Nama pengujian tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="jenis_pengujian" type="text" class="form-control form-control-border border-warning border-width-2" id="jenis_pengujian" placeholder="Jenis Pengujian tidak boleh kosong">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea wire:model="deskripsi_pengujian" class="form-control form-control-border border-warning border-width-2" id="deskripsi_pengujian" rows="5" placeholder="Deskripsi Pengujian tidak boleh kosong"></textarea>
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-8 mb-4">
                                ...
                                <textarea wire:model="alat_pengujian" class="form-control form-control-border border-warning border-width-2" id="alat_pengujian" rows="5" placeholder="Alat Pengujian tidak boleh kosong"></textarea>
                            ...
                            <div class="form-group col-sm-4 mb-4">
                                ...
                                <input wire:model="jumlah_alat" type="text" class="form-control form-control-border border-warning border-width-2" id="jumlah_alat" placeholder="Jumlah Alat tidak boleh kosong">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-8 mb-4">
                                ...
                                <textarea wire:model="metode_pengujian" class="form-control form-control-border border-warning border-width-2" id="metode_pengujian" rows="5" placeholder="Metode Pengujian tidak boleh kosong"></textarea>
                            ...
                            <div class="form-group col-sm-4 mb-4">
                                ...
                                <input wire:model="waktu_pengujian" type="text" class="form-control form-control-border border-warning border-width-2" id="waktu_pengujian" placeholder="Waktu Pengujian tidak boleh kosong">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-8 mb-4">
                                ...
                                <textarea wire:model="keterangan_sampel" class="form-control form-control-border border-warning border-width-2" id="keterangan_sampel" rows="5" placeholder="Keterangan sampel tidak boleh kosong"></textarea>
