                ...
                <div class="card-body">
                    <form>
                        <div class="form-group mb-4">
                            ...
                            <input wire:model="nik_mitra" type="text" class="form-control form-control-border border-danger border-width-2" id="nik_mitra" placeholder="Contoh. Nomor NIK Mitra (16 Digit)." disabled>
