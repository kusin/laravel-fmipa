    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <span class="text-dark">Data TA & Teknisi | Form Tambah Data</span>
            </div>
        </div> {{-- /.col --}}
    </div> {{-- /.row --}}
                ...
                <div class="card-body">
                    <form>
                        <div class="form-group mb-4">
                            ...
                            <input wire:model="nama_pegawai" type="text" class="form-control form-control-border border-success border-width-2" id="nama_pegawai" placeholder="Contoh. Aryajaya Alamsyah">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input wire:model="email_pegawai" type="email" class="form-control form-control-border border-success border-width-2" id="email_pegawai" placeholder="Contoh. aryajayaalamsyah@gmail.com">
                            @error('email_pegawai') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group mb-4">
                            <label for="telp_pegawai" class="required">Telp Pegawai</label>
                            <input wire:model="telp_pegawai" type="text" class="form-control form-control-border border-success border-width-2" id="telp_pegawai" placeholder="Contoh. 0819-xxxx-xxxx">
                            @error('telp_pegawai') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group mb-4">
                            <label for="keahlian" class="required">Keahlian</label>
                            <select wire:model="keahlian" class="form-control form-control-border border-success border-width-2" id="keahlian">
