    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <span class="text-dark">Hasil Pengujian | Form Tambah Data</span>
            </div>
        </div>
        {{-- /.col --}}
    </div>
                    ...
                    <form>
                        ...
                        <div class="form-row border-bottom mb-5">
                            <div class="form-group col-sm-12 mb-2">
                                <h4 class="font-weight-normal text-success">Informasi Pendaftaran</h4>
                            </div>
                            <div class="form-group col-sm-6 mb-4">
                                <label for="id_mitra" class="required">Nama Mitra</label>
                                <select wire:model="id_mitra" class="form-control form-control-border border-success border-width-2" id="id_mitra">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="id_jenis_pengujian" class="form-control form-control-border border-success border-width-2" id="id_jenis_pengujian">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="tanggal_pendaftaran" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_pendaftaran" placeholder="Tanggal pendaftaran tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_pendaftaran" class="form-control form-control-border border-success border-width-2" id="status_pendaftaran">
                        ...
                        <div class="form-row border-bottom mb-5">
                            <div class="form-group col-sm-12 mb-2">
                                <h4 class="font-weight-normal text-success">Sampel Material</h4>
                            </div>
                            <div class="form-group col-sm-6 mb-4">
                                <label for="tanggal_sampel" class="required">Tanggal Sampel</label>
                                <input wire:model="tanggal_sampel" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_sampel" placeholder="Tanggal sampel tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_sampel" class="form-control form-control-border border-success border-width-2" id="status_sampel">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="jenis_sampel" class="form-control form-control-border border-success border-width-2" id="jenis_sampel">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="qty_sampel" type="number" class="form-control form-control-border border-success border-width-2" id="qty_sampel" placeholder="Masukan jumlah QTY sampel">
                        ...
                        <div class="form-row border-bottom mb-5">
                            <div class="form-group col-sm-12 mb-2">
                                <h4 class="font-weight-normal text-success">Pengujian Material</h4>
                            </div>
                            <div class="form-group col-sm-6 mb-4">
                                <label for="tanggal_pengujian_mulai" class="required">Tanggal Mulai Pengujian</label>
                                <input wire:model="tanggal_pengujian_mulai" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_pengujian_mulai" placeholder="Tanggal Mulai Pengujian tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_verifikasi" class="form-control form-control-border border-success border-width-2" id="status_verifikasi">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="tanggal_pengujian_selesai" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_pengujian_selesai" placeholder="Tanggal Selesai Pengujian tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_pengujian" class="form-control form-control-border border-success border-width-2" id="status_pengujian">
                        ...
                        <div class="form-row border-bottom mb-5">
                            <div class="form-group col-sm-12 mb-2">
                                <h4 class="font-weight-normal text-success">Informasi Invoice</h4>
                            </div>
                            <div class="form-group col-sm-6 mb-4">
                                <label for="tanggal_invoice" class="required">Tanggal Invoice</label>
                                <input wire:model="tanggal_invoice" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_invoice" placeholder="Tanggal Invoice tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_invoice" class="form-control form-control-border border-success border-width-2" id="status_invoice">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="nomor_invoice_internal" type="text" class="form-control form-control-border border-success border-width-2" id="nomor_invoice_internal" placeholder="Masukan No. Invoice Internal">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="nomor_invoice_eksternal" type="text" class="form-control form-control-border border-success border-width-2" id="nomor_invoice_eksternal" placeholder="Masukan No. Invoice Eksternal">
                        ...
                        <div class="form-row border-bottom mb-5">
                            <div class="form-group col-sm-12 mb-2">
                                <h4 class="font-weight-normal text-success">Informasi Pembayaran</h4>
                            </div>
                            <div class="form-group col-sm-6 mb-4">
                                <label for="tanggal_pembayaran" class="required">Tanggal Pembayaran</label>
                                <input wire:model="tanggal_pembayaran" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_pembayaran" placeholder="Tanggal Pembayaran tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_pembayaran" class="form-control form-control-border border-success border-width-2" id="status_pembayaran">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="metode_pembayaran" class="form-control form-control-border border-success border-width-2" id="metode_pembayaran">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="nominal_pembayaran" type="number" class="form-control form-control-border border-success border-width-2" id="nominal_pembayaran" placeholder="Masukan Nominal Pembayaran">
                        ...
                        <div class="form-row border-bottom mb-5">
                            <div class="form-group col-sm-12 mb-2">
                                <h4 class="font-weight-normal text-success">Informasi Kwitansi</h4>
                            </div>
                            <div class="form-group col-sm-6 mb-4">
                                <label for="tanggal_kwitansi" class="required">Tanggal Kwitansi</label>
                                <input wire:model="tanggal_kwitansi" type="date" class="form-control form-control-border border-success border-width-2" id="tanggal_kwitansi" placeholder="Tanggal Kwitansi tidak boleh kosong">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <select wire:model="status_kwitansi" class="form-control form-control-border border-success border-width-2" id="status_kwitansi">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="nomor_kwitansi_internal" type="text" class="form-control form-control-border border-success border-width-2" id="nomor_kwitansi_internal" placeholder="Masukan No. Kwitansi Internal">
                            ...
                            <div class="form-group col-sm-6 mb-4">
                                ...
                                <input wire:model="nomor_kwitansi_eksternal" type="text" class="form-control form-control-border border-success border-width-2" id="nomor_kwitansi_eksternal" placeholder="Masukan No. Kwitansi Eksternal">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea wire:model="file_hasil_pengujian" class="form-control form-control-border border-success border-width-2" id="file_hasil_pengujian" rows="5" placeholder="Link download (hasil pengujian, tagihan invoice, dan kwitansi pembyaran)"></textarea>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea wire:model="keterangan" class="form-control form-control-border border-success border-width-2" id="keterangan" rows="5" placeholder="Catatan khusus untuk pengujian material"></textarea>
